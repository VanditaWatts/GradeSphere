...
<body>
	...
	<header>
		<h1>
			Grade<span style="color: #004331;">Sphere</span>
		</h1>
	...
	<div class="container">
		...
		<table>
			...
			<tr>
				...
				<td><%=test.getLevel() %></td>
				<td>
					<button class="btn" onclick="editTest(<%=test.getTestId()%>)" style="background-color:unset;">
						<img width="20" height="20"
							src="https://w7.pngwing.com/pngs/689/183/png-transparent-computer-icons-pen-pen-thumbnail.png" alt="waste"/>
					</button>
