...
<head>
    <meta charset="UTF-8">
    <title>Login to GradeSphere</title>
    ...
    <style>
        ...
        .loginAsAdminButton:hover{
        	background-color: #001c14 !important;
        }
        
        .backToHomeAdmin:hover{
        	background-color: #014331 !important;
        	color: white !important;
        }
    </style>
    ...
    <div class="contents order-2 order-md-1">
        <div class="container">
            <div class="row align-items-center justify-content-center">
                <div class="col-md-7">
                    <h1>Login as <br><strong><span style="color: #014331; font-size: 4rem;">Admin</span></strong></h1>
                    <form action="/TakeTest/AdminLogin" method="post" onsubmit="return validateForm()">
                        ...
                        <input type="submit" value="Log In" class="loginAsAdminButton btn btn-block btn-warning">
                    </form>
                    ...
                    <div class="text-center">
                        <a href="/TakeTest/home.jsp" class="btn-link backToHomeAdmin">Back to Home</a>
                    </div>
                </div>
            </div>
        </div>
