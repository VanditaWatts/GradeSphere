...
<head>
    ...
    <style>
        ...
        .backToHomeAdminLogin:hover, .registerNowUserLogin:hover{
        	background-color: #001c14 !important;
        	color: white !important;
        }
    ...
    <div class="contents order-2 order-md-1">
        <div class="container">
            <div class="row align-items-center justify-content-center">
                <div class="col-md-7">
                    <h1>Login as <br><strong><span style="color: #014331; font-size: 4rem;">User</span></strong></h1>
                    <form action="/TakeTest/UserLogin" method="post">
                        ...
                        <input type="submit" value="Log In" class="userLogin btn btn-block btn-warning">
                    </form>
                    <% 
                    ...
                    <div class="text-center">
                        <a href="/TakeTest/home.jsp" class="btn-link backToHomeAdminLogin">Back to Home</a>
                        <a href="/TakeTest/userPages/userRegister.jsp" class="btn-link registerNowUserLogin">Register Now</a>
                    </div>
                </div>
            </div>
        </div>
