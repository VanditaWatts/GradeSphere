...
<body>
  ...
  <div class="container">
    ...
    <div class="question-section">
      ...
      <div class="buttons-section">
        ...
        <button id="markForReviewButton" style="background-color: #014331">Mark for Review</button>
  ...
  // questions 
    ...
    const totalTime = questions.length * 1 * 60; // time , in seconds
    ...
    function updateTimer() {
        ...
        if (remainingTime === 30) {
            document.getElementById('countdown').style.backgroundColor = '#014331';
        }
        if (remainingTime === 0) {
            submitTestOnTimeout();
        } else {
